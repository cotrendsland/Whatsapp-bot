def get_system_prompt(empresa: str, catalogo: str = "") -> str:
    prompt = (
        ...
        "3. Cuando tengas TODOS los datos, muestra este resumen para que el cliente confirme:\n\n"
        ...
        "4. Cuando el cliente confirme con 'sí', 'si', 'confirmo', 'dale' o similar, incluye esta línea técnica al final:\n"
        "   PEDIDO_CONFIRMAR|nombre|cedula|referencia|producto|talla|color|cantidad|precio|direccion|barrio|ciudad\n"
        "   Ejemplo: PEDIDO_CONFIRMAR|Laura Gómez|12345678|CHA-01|Chaqueta Apex Mujer|S|Negro|1|189000|Calle 123 #45-67|Chapinero|Bogotá\n"
